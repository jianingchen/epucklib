...
EL_API void el_camera_get_frame_pixel(int X,int Y,uint8_t*rgb3v);
EL_API unsigned int el_camera_get_frame_width();
EL_API unsigned int el_camera_get_frame_height();
